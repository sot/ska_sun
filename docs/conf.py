...
# -*- coding: utf-8 -*-
#
# Ska.Sun documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'SkaSun.tex', 'Ska.Sun Documentation',
     'Tom Aldcroft', 'manual'),
]
...
man_pages = [
    (master_doc, 'chandratime', 'Ska.Sun Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SkaSun', 'Ska.Sun Documentation',
     author, 'SkaSun', 'One line description of project.',
     'Miscellaneous'),
]
